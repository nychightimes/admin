...
export default function AddTagGroup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || 'Failed to create tag group');
      }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Add New Tag Group</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6">
          ...
          <div>
            ...
            {!isSlugManuallyEdited && (
              <p className="text-xs text-gray-500 mt-1">
                Auto-generated from group name. You can edit it manually.
              </p>
            )}
          </div>
        ...
        <div className="flex gap-4 mt-8">
          <button
            ...
            disabled={submitting}
          >
            {submitting ? 'Creating...' : 'Create Tag Group'}
          </button>
          <button
            type="button"
